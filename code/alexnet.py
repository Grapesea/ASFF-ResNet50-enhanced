...
def build_alexnet(input_shape=(224, 224, 3), num_classes=2):
    ...
    x = layers.Conv2D(96, (11, 11), strides=(4, 4), padding='same', activation='relu', name='conv1')(inputs)
    ...
    x = layers.MaxPooling2D(pool_size=(3, 3), strides=(2, 2), padding='same', name='maxpool2')(x)

    x = layers.Conv2D(384, (3, 3), padding='same', activation='relu', name='conv3')(x)
    x = layers.Conv2D(384, (3, 3), padding='same', activation='relu', name='conv4')(x)
    ...
    return models.Model(inputs=inputs, outputs=outputs, name='AlexNet')
...
def main():
    ...
    parser.add_argument('--weights_out', default='alexnet_path_to_my_weights.weights.h5')
    parser.add_argument('--weights', default='')
    parser.add_argument('--prefix', default='alexnet')
    parser.add_argument('--metrics_csv', default='')
    parser.add_argument('--variant', default='alexnet')
